...
<div>
<form action="<?php echo U('Zhichu/recorde');?>" method="post">
...
<div>
&nbsp;支出总额:<?php echo ($sum); ?> &nbsp;&nbsp;&nbsp;&nbsp;
当前支出：<?php if($now > 250): ?><span class="label label-danger"><?php echo ($now); ?></span><?php else: ?><span class="label label-success"><?php echo ($now); ?></span><?php endif; ?>
<!-- 分页 -->
...
<div>
	<table class="zebra">
	    ...
	    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
	        ...
	        <a href="<?php echo U('Zhichu/delete',array('id'=>$vo['id'],'belong'=>'recorde'));?>" class="btn btn-default" onclick="return confirm('确定要删除吗')">删除</a>
	        <a href="<?php echo U('Zhichu/update',array('belong'=>'recorde','id'=>$vo['id']));?>" class="btn btn-warning">修改</a>
	        &nbsp;&nbsp;
	        </td>
