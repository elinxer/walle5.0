...
<div>
	<table class="table table-bordered">
		<thead><tr><td>功能推送</td></tr></thead>
		<tbody>
		<tr>
		<td style="text-align:center;">功能名称</td><td>顺序</td><td style="text-align:center;">状态</td><td>&nbsp;&nbsp;操作</td>
		</tr>
		<?php if(is_array($function)): foreach($function as $key=>$function): ?><tr>
			<td style="text-align:center;"><?php if($function['type'] == 0): echo ($function["title"]); else: ?>--<?php echo ($function["title"]); endif; ?></td>
			<td><?php echo ($function["sort"]); ?></td>
			<td style="text-align:center;"><?php if($function['status']): ?><span class="btn btn-success">已推送</span><?php else: ?><span class="btn btn-danger">未推送</span><?php endif; ?></td>
			<td>
				<a href="<?php echo U('Function/push' ,array('id'=>$function['id'],'status'=>1));?>" class="btn">推送</a>&nbsp;&nbsp;<a href="<?php echo U('Function/push' ,array('id'=>$function['id'],'status'=>0));?>" class="btn">取消推送</a>
			</td>
