...
<div>
<form action="<?php echo U('Shouru/recorde');?>" method="post">
...
<div>
&nbsp;收入总额:<?php echo ($sum); ?> &nbsp;&nbsp;&nbsp;&nbsp;
当前收入：<?php if($now > 250): ?><span class="label label-danger"><?php echo ($now); ?></span><?php else: ?>
...
<div>
	<table class="zebra">
	    ...
	    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
	        ...
	        <a href="<?php echo U('Shouru/delete',array('id'=>$vo['id'],'belong'=>'recorde'));?>" class="btn btn-default" onclick="return confirm('确定要删除吗')">删除</a>
	        <a href="<?php echo U('Shouru/update',array('belong'=>'recorde','id'=>$vo['id']));?>" class="btn btn-warning">修改</a>
	        &nbsp;&nbsp;
	        </td>
