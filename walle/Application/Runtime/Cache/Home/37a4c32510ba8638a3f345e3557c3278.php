...
<div style="width:40%">
	<div class="alert alert-success alert-dismissible" role="alert">
	  ...
	  <strong><?php echo ($bakmessage); ?>! </strong>
	  <p><?php echo ($usetime); ?></p>
	</div>
	<p><a href="<?php echo U('System/index');?>" class="btn btn-info">返回</a>&nbsp;
	<a href="<?php echo U('Baksql/backlist');?>" class="btn btn-info">查看备份列表</a></p>
</div>
<p>&nbsp;</p>
<p>&nbsp;</p>
