...
<div>
<a href="<?php echo U('Zhichu/recorde');?>" class="btn btn-large btn-success">记录支出</a>
<div>
...
<div>
	<table class="zebra">
	    ...
	    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
	        ...
	        <a href="<?php echo U('Zhichu/delete',array('id'=>$vo['id'],'belong'=>'index'));?>" class="btn btn-default" onclick="return confirm('确定要删除吗')">删除</a>
	        <a href="<?php echo U('Zhichu/update',array('belong'=>'index','id'=>$vo['id']));?>" class="btn btn-warning">修改</a>
	        &nbsp;&nbsp;
	        </td>
