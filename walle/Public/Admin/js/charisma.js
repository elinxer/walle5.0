$(document).ready(function(){
	...
	{	//绑定了项目名称
		// $('#bs-css').attr('href',"/walle/Public/Admin/css/bootstrap-"+theme_name+'.css');
	}
...
function docReady(){
	...
	if($('.tour').length && typeof(tour)=='undefined')
	{
		...
		tour.addStep({
			...
			placement: "top",
			title: "自定义模块", /* title of the popover */
			content: "你可以自定义模块像下面一样。" /* content of the popover */
		});
		tour.addStep({
			element: ".theme-container",
			placement: "left",
			title: "主题",
			content: "你可以从这里改变页面主题。"
		});
		tour.addStep({
		...
		tour.addStep({
			element: "#for-is-ajax",
			title: "Ajax异步",
			content: "你可以使用异步加载页面数据。"
		});
		tour.addStep({
			element: ".top-nav a:first",
			placement: "bottom",
			title: "查看前台",
			content: "点击这里可以查看你的前台页面。"
		});
